...
namespace Gambit
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Create new database for storing the ModBus data
            DatabaseCreation();
            ...
            while ((line = file.ReadLine()) != null)
            {
                ...
                //Would be good to exclude first row that contains date&time 
        ...
        //Write contents of database in console
            Console.ReadKey();
            QryDatabase();
        ...
        //Function to create SQLite database with table
        ...
        //Future development: The table entries should include date/time of reading as field, to facilitate better functionality/queries
